...
const searchResultExample = {
    ...
    "playlists": {
        "items": [
            {
                "collaborative": false,
                "description": "Best of Radiohead",
                "external_urls": {
                    "spotify": "https://open.spotify.com/playlist/example"
                },
                "href": "https://api.spotify.com/v1/playlists/example",
                "id": "playlist123",
                "images": [
                    {
                        "height": 640,
                        "url": "https://mosaic.scdn.co/example",
                        "width": 640
                    }
                ],
                ...
                "public": true,
                "snapshot_id": "MTY4MjA5NTY4MCwwMDAwMDAwMGQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0Mjdl",
                "tracks": {
                    "href": "https://api.spotify.com/v1/playlists/example/tracks",
                    "total": 50
                },
                "type": "playlist",
...
export type SearchResult = typeof searchResultExample;
export type SearchResultItem = {
    tracks?: { items: Track[], limit: number, offset: number, total: number };
    albums?: { items: Album[], limit: number, offset: number, total: number };
    artists?: { 
        items: Array<{
            id: string;
            name: string;
    ...
    playlists?: { items: Playlist[], limit: number, offset: number, total: number };
};
