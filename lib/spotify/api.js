...
exports.getApi = exports.DELETE = exports.PUT = exports.POST = exports.GET = exports.apiUrl = void 0;
    ...
    return {
        me: {
            ...
            tracks: {
                ...
                put: function (trackUri) { return __awaiter(void 0, void 0, void 0, function () {
                    var body;
                    return __generator(this, function (_a) {
                        body = JSON.stringify(__assign({}, (trackUri ? { "uris": [trackUri] } : {})));
                        return [2 /*return*/, makeRequest(queryParamsHelper("me/tracks", { 'ids': trackUri }), __assign(__assign({ body: body }, exports.PUT), headers))];
                    });
                }); },
                // Treated as unliking the song
                delete: function (trackUri) { return __awaiter(void 0, void 0, void 0, function () {
                    var body;
                    return __generator(this, function (_a) {
                        body = JSON.stringify(__assign({}, (trackUri ? { "uris": [trackUri] } : {})));
                        return [2 /*return*/, makeRequest(queryParamsHelper("me/tracks", { 'ids': trackUri }), __assign(__assign({ body: body }, exports.DELETE), headers))];
                    });
                }); },
                contains: {
                    get: function (trackUri) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, makeRequest(queryParamsHelper("me/tracks/contains", { 'ids': trackUri }), __assign(__assign({}, exports.GET), headers))];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        });
                    }); }
        ...
        player: {
            ...
            play: {
                put: function (params) { return __awaiter(void 0, void 0, void 0, function () {
                    var trackUri, albumUri, playlistUri, deviceId, offset, body;
                    return __generator(this, function (_a) {
                        trackUri = params.trackUri, albumUri = params.albumUri, playlistUri = params.playlistUri, deviceId = params.deviceId, offset = params.offset;
                        body = {};
                        if (playlistUri) {
                        ...
                        return [2 /*return*/, makeRequest(queryParamsHelper("me/player/play", { 'device_id': deviceId }), __assign(__assign({ body: JSON.stringify(body) }, exports.PUT), headers))];
                    });
                }); }
            },
            pause: {
            ...
            currentlyPlaying: {
                get: function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, makeRequest('me/player/currently-playing', __assign(__assign({}, exports.GET), headers))];
                    });
                }); },
            }
        },
        ...
        albums: {
            get: function (options) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    opt = __assign({ limit: 50, offset: 0 }, options);
                    return [2 /*return*/, makeRequest(queryParamsHelper("me/albums", opt), __assign(__assign({}, exports.GET), headers))];
                });
            }); },
            getAll: function () {
                return __awaiter(this, void 0, void 0, function () {
                    var albums, limit, getOperations, i, offset, res;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                albums = [];
                ...
                getAll: function (_a) {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_b) {
                            return [2 /*return*/, album.tracks.items.map(function (track) { return ({
                                    track: __assign(__assign({}, track), { album: { id: album.id, name: album.name } }),
                                }); })];
                        });
                    });
                },
        ...
        search: {
            get: function (query, type, options) { return __awaiter(void 0, void 0, void 0, function () {
                var opt;
                return __generator(this, function (_a) {
                    opt = __assign({ q: query, type: type.join(','), limit: 20, offset: 0 }, options);
                    return [2 /*return*/, makeRequest(queryParamsHelper('search', opt), __assign(__assign({}, exports.GET), headers))];
                });
            }); }
        }
    };
